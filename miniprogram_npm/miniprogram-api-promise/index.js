...
__DEFINE__(1601453942705, function(require, module, exports) {
...
}, function(modId) {var map = {"./promise":1601453942706}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1601453942706, function(require, module, exports) {
...
// 改写_promisify，支持wx.XXX返回的对象实例，去执行该实例的一些方法，如RequestTask.abort
function _promisify(func) {
  if (typeof func !== 'function') return fn
  return (args = {}) =>{
...
}, function(modId) { var map = {"./method":1601453942707}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1601453942707, function(require, module, exports) {
...
return __REQUIRE__(1601453942705);
})()
